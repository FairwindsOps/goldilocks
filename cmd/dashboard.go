...
func init() {
	...
	dashboardCmd.PersistentFlags().StringVar(&insightsHost, "insights-host", "https://staging.insights.fairwinds.com", "Insights host for retrieving optional cost data.")
}
